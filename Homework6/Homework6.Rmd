...
**Answer:** The probability that an elevator holding 15 people would be carrying more than 3,500 pounds is **`r round(prob_exceed, 6)`** or about `r round(prob_exceed * 100, 4)`%.
...
**Conclusion:** Since the expected total sales over 30 days is `r mean_total` bottles, selling more than 600 bottles would be `r if(prob_exceed > 0.5) "somewhat likely" else "unlikely"`. The value of 600 is `r if(target_total > mean_total) "above" else "below"` the expected value of `r mean_total` bottles.
